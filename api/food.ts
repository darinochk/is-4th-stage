...
export async function CreateFood(eventRequest: any, setMessage: (mess: Message) => void): Promise<Food | null> {
    try {
...
export async function UpdateFood(id: number, eventRequest: any, setMessage: (mess: Message) => void): Promise<Food | null> {
    try {

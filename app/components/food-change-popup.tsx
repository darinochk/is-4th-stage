        ...
        return (
            <dialog ref={dialogRef} onClick={e => {
                ...
                <form method='dialog' className={styles.form} style={{ marginTop: '10px' }}
                    ...
                    <label>
                        Название<br />
                        <input type="text" name="name" value={foodInternal.name || ''}
                               onChange={handleFoodChange} required />
                    </label>
                    <label>
                        Тип<br />
                        <input type="text" name="foodType" value={foodInternal.foodType || ''}
                               onChange={handleFoodChange} required />
                    </label>
                    <label>
                        Цена<br />
                        <input type="number" name="price" value={foodInternal.price || ''}
                               onChange={handleFoodChange} required min={1} step={1}/>
                    </label>
